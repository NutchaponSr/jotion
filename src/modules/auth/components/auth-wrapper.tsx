...
export const AuthWrapper = ({
  ...
  return (
    <div className="flex flex-col items-center h-full">
      ...
      <div className="flex flex-col items-center w-full max-w-[320px] mb-[16vh] space-y-4 pb-[4vh]">
        <div className="flex flex-col w-full">
          {children}
        </div>
        <div className="w-full mt-12 mb-0 text-xs text-[#787774] text-center text-balance">
          <p className="mb-0">
