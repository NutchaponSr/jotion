...
const buttonVariants = cva(baseStyles, {
  variants: {
    variant: {
      ...
      primaryForeground: "bg-sky-500 hover:bg-sky-600/90 shadow-[inset_0_0_0_1px_rgba(15,15,15,0.1),0_1px_2px_rgba(15,15,15,0.1)] text-white",
      warning: `bg-warning text-white ring-1 ring-warning ${variantEffects}`,
      ghost: "hover:bg-accent hover:text-primary text-primary",
      filter: "text-[#7c7c78] hover:bg-[#37352f0f] dark:hover:bg-[#ffffff0e] border border-dashed border-[#37352f29] dark:border-[#ffffff21]",
      filterActive: "bg-[#2383e208] text-sky-500 hover:bg-[#2383e212] border border-dashed border-sky-400/40",
    },
    size: { 
